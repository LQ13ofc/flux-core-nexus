...
import { Settings as SettingsIcon, Shield, Monitor, Network, HardDrive, Cpu as Chip, Ghost, Eraser, Save } from 'lucide-react';
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar p-8">
        <div className="max-w-5xl mx-auto space-y-8 pb-10 animate-in fade-in slide-in-from-bottom-2">
            ...
            {/* Tabs */}
            <div className="flex items-center gap-2 p-1.5 bg-[#141417] rounded-2xl border border-white/5 sticky top-0 z-10 shadow-xl backdrop-blur-md">
            ...
            <div className="pt-8 border-t border-white/5 flex items-center justify-between">
                ...
                <button className="flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white font-black text-[10px] rounded-xl transition-all uppercase tracking-widest shadow-lg shadow-blue-900/20 active:scale-95">
                    <Save size={14} />
                    Save Profile
                </button>
            </div>
...
const SettingsSection: React.FC<{ title: string, icon: React.ReactNode, children: React.ReactNode }> = ({ title, icon, children }) => (
  <div className="bg-[#141417] border border-white/5 rounded-3xl overflow-hidden shadow-lg">
